...
NOTICE: If your dice roll is equal to a 2 or 7, you get a 10 mon bonus
''')
...
while True:  # Main game loop.
    ...
    # Check for dice roll total of 2 or 7
    total = (dice1 + dice2)
    if total == 2 or total ==7:
        print(f'The total of the dice roll is {total}, so you get a 10 mon bonus!')
        purse += 10
